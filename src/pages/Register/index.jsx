...
export default function Register() {
  ...
  const toggleVisiblityPassword = ({ type }) => {
    if (type === "password") {
  ...
  return (
    <div className="flex min-h-full flex-1 flex-col justify-center h-screen px-6 py-12 lg:px-8 bg-[#111827]">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        <FaRocketchat className="mx-auto my-4 text-[40px] text-indigo-600" />
          ...
          <div>
            ...
            <div className="mt-2 relative">
              ...
              <span
                ...
                onClick={() => toggleVisiblityPassword({ type: "password" })}
              >
                {isShowPassword ? (
                  <BiSolidShow size={20} />
                ) : (
          ...
          <div>
            ...
            <div className="mt-2 relative">
              ...
              <span
                className="cursor-pointer absolute inset-y-0 right-0 top-3 flex items-center pr-3 mb-3"
                onClick={() =>
                  toggleVisiblityPassword({ type: "confirm-password" })
                }
              >
